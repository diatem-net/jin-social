...
namespace Jin2\Social\Instagram;
...
class Instagram
{
   ...
   * @param string $scope          (optional) Degrés d'authorisation dont l'application à besoin (Défault : public_content)
   */
  ...
  public function query($query, $params = array())
  {
    ...
    $result = json_decode($curl->call(self::INSTAGRAM_API_URL . trim($query, '/') . '?' . http_build_query($params), array(), 'GET', true), true);
