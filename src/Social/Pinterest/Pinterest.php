...
namespace Jin2\Social\Pinterest;
 ...
 *
 * @see  https://developers.pinterest.com/docs/
 */
class Pinterest
{
   ...
   * @param string $scope          (optional) Degrés d'authorisation dont l'application à besoin (Défault : read)
   */
  ...
  public function query($query, $params = array())
  {
    ...
    $result = json_decode($curl->call(self::PINTEREST_API_URL . trim($query, '/') . '/?' . http_build_query($params), array(), 'GET', true), true);
