...
namespace Jin2\Social\Facebook;
 ...
 *
 * @see http://stackoverflow.com/questions/28124078/get-latest-facebook-posts-of-page-with-php-sdk
 *
 * Procédure :
 *
...
class Facebook
{
  ...
  public function __construct($client_id, $client_secret, $access_token, $debug_mode = false)
  {
    ...
    FacebookSession::setDefaultApplication($this->client_id, $this->client_secret);
